                                ...
                                <div class="w-full md:w-1/3 mx-auto">
                                    <div class="flex flex-col p-5 rounded-lg shadow bg-white">
                                        <div class="flex flex-col items-center text-center">
                                            ...
                                            <h2 class="mt-2 font-semibold text-gray-800">알람창</h2>
                                            <p class="mt-2 text-sm text-gray-600 leading-relaxed">{props.content}</p>
                                        </div>

                                        <div class="mt-3">
                                            <button
                                                class="w-full px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-800 text-sm font-medium rounded-md"
