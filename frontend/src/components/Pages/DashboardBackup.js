  ...
  return (
    <div className="grid grid-cols-10 gap-5 text-center">
      <div className="col-span-8 grid grid-rows-2 gap-5">
        <div className="grid grid-cols-5 gap-5">
          <div className="rounded-lg grid gap-3 py-3 break-words">
            ...
            {agingRankingList.map((agingItem, index) => {
              return (
                <div className="bg-stone-300 rounded-lg mx-3 px-2 text-ellipsis overflow-hidden truncate">
        ...
        <div className="grid grid-cols-5 gap-5">
          <div className="col-span-3 rounded-lg p-5">
            <ChartLine />
          </div>
          <div className="col-span-2 rounded-lg p-5">
            <ChartBar1 />
          </div>
        </div>
      </div>
