...
function LogisticsImport(props) {
  ...
  const th = [
    ...
    { "ko": "입고수량", "en": "im_amount", "cn": "入库数量", "jp": "入庫数量", "vn": "số lượng nhập kho", "size": 300, type: "number" },
    ...
    { "ko": "산업군", "en": "industry_family", "cn": "产业群", "jp": "産業群", "vn": "lực lượng công nghiệp", "size": 300, type: "string" },
    ...
    { "ko": "창고코드", "en": "to_warehouse", "cn": "仓库代码", "jp": "倉庫コード", "vn": "mã kho", "size": 300, type: "string" },
