...
function LogisticsImport(props) {
  ...
  const th = [
    ...
    { "ko": "제품명", "en": "item_name", "cn": "产品名称", "jp": "製品名", "vn": "Tên sản phẩm là", size: 250, type: "left", fixed: "" },
    { "ko": "주문량", "en": "order_amount", "cn": "订货量", "jp": "注文量", "vn": "lượng đặt hàng", size: 80, type: "right", fixed: "" },
    { "ko": "입고수량", "en": "im_amount", "cn": "入库数量", "jp": "入庫数量", "vn": "số lượng nhập kho", size: 90, type: "right", fixed: "" },
    ...
    { "ko": "산업군", "en": "industry_family", "cn": "产业群", "jp": "産業群", "vn": "lực lượng công nghiệp", size: 100, type: "left", fixed: "" },
