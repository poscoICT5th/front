      ...
      <div className="grid grid-cols-7 gap-4 text-center">
        ...
        <div className="col-span-1">
          ...
          <Select
            ...
            classNamePrefix="select"
            maxMenuHeight={200}
            onChange={(e) => { props.setDatas({ ...props.datas, location: e.value }); }}
          />
        </div>
        <div className="col-span-1">
          <label htmlFor="dropdown" className="block text-sm font-medium text-gray-700">
          ...
          <Select
            ...
            classNamePrefix="select"
            maxMenuHeight={200}
            onChange={(e) => { props.setDatas({ ...props.datas, product_family: e.value }); }}
          />
        </div>
        {/* 단위 */}
        <div className="col-span-1">
        ...
        <div className="col-span-1">
          ...
          <Select
            ...
            classNamePrefix="select"
            maxMenuHeight={200}
            onChange={(e) => { props.setDatas({ ...props.datas, from_warehouse: e.value }); }}
          />
        </div>
      </div>
      {/* 둘재줄 */}
        ...
        <div className="col-span-1 grid grid-cols-4 text-center">
          ...
          <div>
            <input
              ...
              onChange={(e) => { props.setDatas({ ...props.datas, min_width: e.value }); }}
            /></div>
          ...
          <div>
            <input
              ...
              autoComplete="address-level2"
              className="mt-1 focus:ring-sky-500 focus:border-sky-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
              onChange={(e) => { props.setDatas({ ...props.datas, max_width: e.value }); }}
            />
          </div>
        </div>
        <div className="col-span-1 grid grid-cols-4 text-center">
        ...
        <div className="col-span-1 grid grid-cols-4 text-center">
          ...
          <div>
            <input
              ...
              autoComplete="address-level2"
              className="mt-1 focus:ring-sky-500 focus:border-sky-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
              onChange={(e) => { props.setDatas({ ...props.datas, min_ex_amount: e.value }); }}
            /></div>
          <div className='text-xs'>-</div>
          <div>
            <input
              ...
              autoComplete="address-level2"
              className="mt-1 focus:ring-sky-500 focus:border-sky-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
              onChange={(e) => { props.setDatas({ ...props.datas, max_ex_amount: e.value }); }}
            />
          </div>
        </div>
        {/* 중량 */}
